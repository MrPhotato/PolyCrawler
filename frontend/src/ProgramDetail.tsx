...
import { Modal, Typography, Descriptions, Collapse, List, Tag, Divider } from 'antd';
    ...
    >
      <Typography>
        <Descriptions title="基本信息" bordered column={1}>
          <Descriptions.Item label="大学">{program.university}</Descriptions.Item>
          ...
          <Descriptions.Item label="学术水平">{program.academic_level}</Descriptions.Item>
          ...
          <Descriptions.Item label="费用范围">{program.fee_range}</Descriptions.Item>
          <Descriptions.Item label="国内费用">
            S${program.domestic_total_fee.fee_lower.toLocaleString()} - S${program.domestic_total_fee.fee_upper.toLocaleString()}
          </Descriptions.Item>
          <Descriptions.Item label="国际费用">
